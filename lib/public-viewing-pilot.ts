...
const pilotConfigs: Record<string, PublicViewingPilotConfig> = {
  ...
  "public-viewing-quickborn": {
    ...
    prizeTitle: "Das kannst du gewinnen",
    prizeMain: "2 Gutscheine im Wert von je 20 €",
    prizeChips: ["2 Gästelistenplätze MBOA", "20 % Adidas", "15 % JD Sports", "15 % ABOUT YOU"],
    ...
    prizePoolAdminText: "Gewinnpool: 2 Gutscheine je 20 €, 2 Gästelistenplätze für das MBOA am 10. & 11.07. bis zum möglichen Viertelfinale am 09.07., 1x 20 % Adidas, 1x 15 % JD Sports, 1x 15 % ABOUT YOU.",
    ...
    detailedPrizes: [
      "2 Gutscheine im Wert von je 20 € - einmalig einlösbar auf der Veranstaltung",
      "Bis zum möglichen Viertelfinale am 09.07.: 2 Gästelistenplätze für das MBOA am 10. & 11.07.",
      "1x 20 % Adidas Gutschein",
      "1x 15 % JD Sports Gutschein",
      "1x 15 % ABOUT YOU Gutschein",
    ],
