  ...
  theme: {
    extend: {
      colors: {
        ...
        primary: "var(--bubble-primary, #0058be)",
        "primary-container": "var(--bubble-primary-container, #2170e4)",
        "on-primary": "#ffffff",
        "on-primary-container": "#fefcff",
        secondary: "var(--bubble-secondary, #b61722)",
        "on-secondary": "#ffffff",
        tertiary: "var(--bubble-tertiary, #924700)",
        "tertiary-container": "var(--bubble-tertiary, #b75b00)",
