...
const outcomeOptions: Array<{ value: MatchOutcome; label: string }> = [
  { value: "deutschland", label: "Deutschland" },
  { value: "unentschieden", label: "Unentschieden" },
  { value: "ecuador", label: "Ecuador" },
];

const prizeChips = ["1x 20 % adidas Rabatt", "1x 15 % JD Sports Rabatt", "1x 15 % ABOUT YOU Rabatt"];

function scoreLabel(matchState: BubbleMatchStateRow | null) {
  ...
  return `Live: ${matchState.team_home || "Deutschland"} ${matchState.current_germany_score} : ${matchState.current_ecuador_score} ${matchState.team_away || "Ecuador"}`;
}
    ...
    <MobilePage title="Huber Arena" subtitle="Public Viewing">
      <div className="space-y-4">
            ...
            <form className="space-y-5" onSubmit={openContactStep}>
              ...
              <label className="block">
                ...
                <input
                  ...
                  placeholder="z. B. 2:1 Deutschland"
        ...
        <section className="grid gap-3">
          <PrizeTeaser href={bubblePath(bubbleSlug, "/benefits")} />
          <TeaserCard
    ...
    <section className="rounded-[1.35rem] bg-white p-4 shadow-ambient">
      ...
      <dl className="grid gap-2 rounded-[1rem] bg-surface p-3 text-sm">
        <div className="flex items-center justify-between gap-3">
          ...
          <dd className="font-black text-on-surface">{outcomeLabel(outcomePick || null)}</dd>
        </div>
        <div className="flex items-center justify-between gap-3">
    ...
    <section className="rounded-[1.25rem] bg-white p-4 shadow-ambient">
      <div className="flex items-start gap-3.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-3 text-xs font-semibold leading-5 text-on-surface-variant">Unter allen richtigen Tipps werden die Gewinne nach dem Spiel verlost.</p>
